...
\item \textit{Grabación de partidas a csv:} añadimos una funcionalidad para grabar las partidas
  ...
  una red neuronal \textit{NN} controla las blancas, se guardará en \texttt{agent/training/BOTvsAGENT\_NN.csv} 
  Posteriormente, todos estos ficheros se copiarán en \texttt{agent/training/training\_data.csv} 
