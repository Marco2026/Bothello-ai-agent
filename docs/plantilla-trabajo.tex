...
\item \textit{Agente MCTS vs Agente MCTS}:
  \begin{enumerate}
    ...
    neuronal. Dado que los bots no mostraron ningún patrón extraño, simplemente
    esperábamos encontrar un porcentaje casi idéntico de victorias para cada jugador.
    \item \textit{Resultados}\\
    Con una muestra de 200 partidas generadas, obtuvimos los siguientes resultados:
    \begin{itemize}
      \item \textit{Victorias de Player 1}: 
